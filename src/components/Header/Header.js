    ...
    return (
        <div className='px-5 grid grid-cols-2 justify-between items-center bg-gray-800'>
            ...
            <div>
                ...
                <div className={`flex justify-end md:flex-row sm:flex-col xs:flex-col md:static xs:bg-lime-600 md:bg-transparent xs:w-full absolute ${open ? 'top-20' : 'top-[-200px]'}`}>
                ...
                <div className='md:hidden' onClick={() =>setOpen(!open)} >
                    <span>{open ? 
                    <FontAwesomeIcon className='p-2 text-xl' icon={faXmark} /> 
                    : 
                    <FontAwesomeIcon className='p-2 text-xl' icon={faBars} />}
                    </span>
                </div>
            </nav>
          </div>
